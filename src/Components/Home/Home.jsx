        ...
        <div className="grid grid-cols-2 text-start">
          <div className="col-span-1 ml-52 mt-28">
            ...
            <p className="font-kodeMono text-white mt-6">
              {`Hi! Welcome to my place, well I am just a developer,
               programmer, and problem-solver with a passion for
                building scalable systems. As an engineer, I thrive 
                on solving challenges, and in my downtime, 
                I enjoy gaming for fun and creative inspiration...`}
            </p>
            ...
            <div className="flex items-center justify-start mt-6 gap-8">
              <button className="hover:bg-[#64ccc5] hover:text-black text-[#64ccc5] text-xl py-2 px-4 font-semibold rounded-xl border-2 border-[#64ccc5]">
                <a
                   href="/Ansh_Goel_Resume.pdf"
                   download="Ansh_Goel_Resume.pdf"
                >
                  Download Resume
                </a>
              </button>
              <button>
                {" "}
                <a href="https://github.com/Ansh1435" target="_blank">
                  <FontAwesomeIcon
                    icon={faGithub}
              ...
              <button>
                <a
                  href="https://www.linkedin.com/in/ansh-goel-5bb09b2b5/"
                  target="_blank"
                >
                  <FontAwesomeIcon
                    icon={faLinkedin}
