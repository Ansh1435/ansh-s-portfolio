          ...
          <table>
            ...
            <tbody className="text-white text-xl">
              ...
              <tr className="border-b-2 border-[#64ccc5]">
                ...
                <td className="border-2 border-[#64ccc5] p-4">
                  Rosary Senior Secondary School , New Delhi
                </td>
                <td className="border-2 border-[#64ccc5] p-4">2020</td>
                <td className="border-2 border-[#64ccc5] p-4">83.4%</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table>
            ...
            <tbody className="text-white text-lg">
              ...
              <tr className="border-b-2 border-[#64ccc5]">
                ...
                <td className="border-2 border-[#64ccc5] p-2">83.4%</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="mb-4">
            ...
            <tbody className="text-white text-xs">
              ...
              <tr className="border-b-2 border-[#64ccc5]">
                ...
                <td className="border-2 border-[#64ccc5] p-1">83.4%</td>
              </tr>
            </tbody>
          </table>
        </div>
